...
# Mindkét könyvtárba futásidőben írunk, ezért az alkalmazás felhasználójáé kell
# legyen. Az itteni létrehozás miatt egy volume nélküli első indítás is működik.
