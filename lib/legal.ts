...
félhez intézett írásos nyilatkozattal, [felmondási idő] felmondási idővel. A
...
A megkereséseket a megválaszolást követő [időtartam] ideig, szerződéskötés esetén
a szerződéses jogviszonyból eredő igények elévüléséig őrizzük. A szerverek
technikai naplóit legfeljebb [időtartam] ideig tároljuk.
...
const descriptions: Record<string, string> = {
  impresszum: `A ${site.name} üzemeltetőjének adatai, elérhetősége és tárhelyszolgáltatója.`,
  aszf: `A ${site.name} általános szerződési feltételei: ajánlat, díjazás, teljesítés, tulajdonjog és üzemeltetés.`,
  'adatkezelesi-tajekoztato':
    'Milyen személyes adatokat kezelünk, meddig őrizzük őket, és milyen jogaid vannak.',
  'cookie-tajekoztato': `Milyen sütiket használ a ${site.name} weboldala, és hogyan kezelheted őket.`,
};
