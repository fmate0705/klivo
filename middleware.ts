 ...
 * `requireSession()`-t, és minden admin route handler a `requireApiSession()`-t,
 * tehát ha egy útvonal kiesik az alábbi matcherből, az teljesítményt ront, nem
 * biztonságot.
 *
...
export async function middleware(request: NextRequest) {
  ...
  // Csak az útvonalat visszük tovább, soha nem abszolút URL-t — az utóbbi nyílt
  // átirányítássá tenné a belépő oldalt.
  if (pathname !== '/admin') {
