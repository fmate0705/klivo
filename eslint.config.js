...
export default tseslint.config(
  ...
  },
  {
    ...
    // globális, és a kiírás a funkciójuk. A `window`/`document` azért kell,
    // mert a képernyőkép-szkript `page.evaluate()`-tel böngészőben futó kódot is
    // tartalmaz — ott ezek valóban léteznek.
