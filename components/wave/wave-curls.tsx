...
const WAVES: StackWave[] = [
  { x: 0.5, y: 0.02, angle: -6, wide: 0.66, tall: 14, crests: 0.8, steep: 0.3, phase: 0.1, rim: 20, swell: 0.86, rimTone: 'wave-7', bodyTone: 'wave-8', line: 0.2 },
  { x: 0.6, y: 0.06, angle: 9, wide: 0.5, tall: 13.5, crests: 1.6, steep: 0.26, phase: 0.35, rim: 14, swell: 0.9, rimTone: 'wave-7', bodyTone: 'wave-9', line: 0.16 },
  { x: 0.46, y: 0.1, angle: 5, wide: 0.74, tall: 13, crests: 1.2, steep: 0.32, phase: 0.55, rim: 18, swell: 0.88, rimTone: 'wave-7', bodyTone: 'wave-9', line: 0.22 },
  { x: 0.54, y: 0.19, angle: -10, wide: 0.58, tall: 12, crests: 0.9, steep: 0.28, phase: 0.3, rim: 22, swell: 0.84, rimTone: 'wave-7', bodyTone: 'wave-8', line: 0.18 },
  { x: 0.44, y: 0.28, angle: 7, wide: 0.7, tall: 11, crests: 1.4, steep: 0.24, phase: 0.8, rim: 20, swell: 0.88, rimTone: 'wave-8', bodyTone: 'wave-9', line: 0.2 },
  { x: 0.36, y: 0.32, angle: -13, wide: 0.44, tall: 10.5, crests: 1.9, steep: 0.3, phase: 0.62, rim: 16, swell: 0.9, rimTone: 'wave-8', bodyTone: 'wave-9', line: 0.16 },
  { x: 0.56, y: 0.36, angle: -4, wide: 0.62, tall: 10, crests: 1, steep: 0.34, phase: 0.15, rim: 24, swell: 0.85, rimTone: 'wave-9', bodyTone: 'wave-8', line: 0.22 },
  { x: 0.42, y: 0.44, angle: 9, wide: 0.76, tall: 9.5, crests: 1.6, steep: 0.26, phase: 0.45, rim: 18, swell: 0.88, rimTone: 'wave-8', bodyTone: 'wave-9', line: 0.18 },
  { x: 0.68, y: 0.47, angle: 12, wide: 0.4, tall: 9.2, crests: 2.2, steep: 0.3, phase: 0.18, rim: 16, swell: 0.89, rimTone: 'wave-9', bodyTone: 'wave-8', line: 0.2 },
  { x: 0.52, y: 0.51, angle: -12, wide: 0.54, tall: 9, crests: 1.1, steep: 0.32, phase: 0.7, rim: 26, swell: 0.83, rimTone: 'wave-9', bodyTone: 'wave-8', line: 0.22 },
  { x: 0.48, y: 0.58, angle: 6, wide: 0.68, tall: 8, crests: 1.8, steep: 0.28, phase: 0.25, rim: 22, swell: 0.87, rimTone: 'wave-8', bodyTone: 'wave-9', line: 0.18 },
