  ...
  return (
    <div className="space-y-8">
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h1 className="text-h4 font-semibold">Bejegyzések</h1>
              ...
              >
                <div className="min-w-0">
                  <Link
                    ...
                    className="text-[0.9375rem] font-medium text-ink hover:text-ink"
                  >
                    {post.title}
                  </Link>
                ...
                <div className="flex items-center gap-3">
                  <span
                    className={
                      post.published
                        ? 'rounded-pill bg-success/10 px-2.5 py-0.5 text-xs font-medium text-success ring-1 ring-inset ring-success/20'
                        : 'rounded-pill bg-sky px-2.5 py-0.5 text-xs font-medium text-muted ring-1 ring-inset ring-line'
                    }
                  >
